...
{
    public class GateAND : MonoBehaviour, IDevice
    {
        ...
        public int CheckElectricalSystem(bool isCurrent)
        {
            ...
            outputMeshRenderer.materials[2] = isActiveDevise ? materialConfig.onMaterial : materialConfig.offMaterial;
